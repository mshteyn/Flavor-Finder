...
if torch.cuda.is_available():     
    ...
    model = AutoModelForCausalLM.from_pretrained(MODEL_NAME, torch_dtype=torch.float16, trust_remote_code=True, device_map="cuda", token ='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')
