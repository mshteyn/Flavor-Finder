...
Manual evaluation on responses generated by (1) original Llama 2; (2) Flavor-Finder; (3) GPT-4o. Scores range from 0-4 based on whether the dish recommendation is a real menu item from the correct restaurant and responsive to the particularity of user query. 
