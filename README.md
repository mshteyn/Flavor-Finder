...
20 local restaurants with 50-500 reviews were selected for model performance evaluation. For each restaurant, customized questions were asked for dish recommendation, examples:
- If I want the best sandwich, what should I get at Central Diner & Grille?
- I don't like mushroom, what dish do you recommend at Vedge?

3 reviewers manually graded on responses generated by (1) original Llama 2; (2) Flavor-Finder; (3) GPT-4o. Scores range from 0-4 based on whether the dish recommendation is a real menu item from the correct restaurant and responsive to the particularity of user query. 
